...
W_fc1_rns = tf.placeholder(tf.float16, [64*64*4*conv_base, fc_2_node])
...
def train_step_epoch(ii):
	...
	for i in range((restore_step%(STEP_PER_EPOCH_s//batch_size_old))+ii2,(STEP_PER_EPOCH_s//batch_size)+ii2):
		...
		## variable ##
		if i % 500 == 0: # 100
			save_path = saver.save(sess, "net13/save_net.ckpt")
...
#mppyplot.show()
# nohup python3 -u seamcarving_detect13.py > nohup.log 2>&1 &
