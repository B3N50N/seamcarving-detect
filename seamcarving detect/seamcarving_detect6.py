...
# tf.summary.scalar("loss_train", save_res1g)
tf.summary.scalar("loss_validate", save_res2g)
...
for i in range(STEP_PER_EPOCH_s//batch_size * EPOCHS_PRESET):
	...
	## variable ##
	if i % 100 == 0: # 100
		save_path = saver.save(sess, "net6/save_net.ckpt")
...
#mppyplot.show()
# nohup python3 -u seamcarving_detect6.py > nohup.log 2>&1 &
